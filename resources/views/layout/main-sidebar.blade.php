            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ request()->is('/') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('home') }}" class="menu-link">
                        ...
                        <span class="menu-text">{{ __('controll_panel') }}</span>
                    </a>
                </li>

                <li class="menu-section">
                    <h4 class="menu-text">{{ __('E-Commerce') }}</h4>
                ...
                @can('index permissions', 'update permissions', 'delete permissions', 'index roles', 'update roles',
                    ...
                    <li class="menu-item menu-item-submenu {{ request()->is('permissions*') ? 'menu-item-active' : '' }}"
                        aria-haspopup="true" data-menu-toggle="hover"><a href="javascript:;" class="menu-link menu-toggle">
                            ...
                            <span class="menu-text">{{ __('setting') }}</span><i class="menu-arrow"></i></a>
                        <div class="menu-submenu " kt-hidden-height="80" style="display: none; overflow: hidden;"><i
                            ...
                            <ul class="menu-subnav ">
                                <li class="menu-item  menu-item-parent" aria-haspopup="true"><span
                                        class="menu-link"><span class="menu-text">{{ __('setting') }}</span></span>
                                </li>
